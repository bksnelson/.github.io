...
<div class="row justify-content-center">
    <img width="900px" alt="" class="pe-4" src="../img/RepCompanion/home.png">
</div>
...
<div class="row justify-content-center">
    <img width="900px" alt="" class="pe-4" src="../img/RepCompanion/profiles.png">
</div>
...
<div class="row justify-content-center">
    <img width="900px" alt="" class="pe-4" src="../img/RepCompanion/events.png">
</div>
...
<div class="row justify-content-center">
    <img width="900px" alt="" class="pe-4" src="../img/RepCompanion/schedule.png">
</div>
